		...
		if ( 'payment' === $this->credit_card_form_type ) {
			...
			<div class="fkwcs-credit-card-field">
				...
				<div class="fkwcs-form-row fkwcs-form-row-wide">
					<label for="stripe-card-element"><?php esc_html_e( 'Card number', 'woocommerce' ); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch ?> <span class="required">*</span></label>
				...
				<div class="fkwcs-form-row fkwcs-form-row-wide fkwcs-field-wrapper">
					<div class="fkwcs-form-row-first">
						<label for="stripe-card-expiry"><?php esc_html_e( 'Expiry date', 'woocommerce' ); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch ?> <span class="required">*</span></label>
					...
					<div class="fkwcs-form-row-last">
						<label for="stripe-card-cvc"><?php esc_html_e( 'CVC', 'woocommerce' ); //phpcs:ignore WordPress.WP.I18n.TextDomainMismatch ?> <span class="required">*</span></label>
						<div class="fkwcs-card-exp fkwcs-stripe-card-group">
